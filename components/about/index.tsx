    ...
    >
      <div className="mx-auto max-w-6xl">
        <SectionHeader
          ...
          title={
            <>
              I blend <em className="not-italic">engineering</em>{" "}
          ...
          <Reveal width="w-full">
            <div className="space-y-4">
              ...
              <p className="leading-relaxed text-[var(--ink-muted)]">
                ...
                including the labs, the wins, the things that broke and why.
                You can follow along on the blog.
              </p>
              <p className="leading-relaxed text-[var(--ink-muted)]">
              ...
              <p className="leading-relaxed text-[var(--ink-muted)]">
                I&apos;m currently open to full stack engineering roles. If
                what you&apos;re working on sounds interesting, reach out.
              </p>
