...
const Hero_V3 = () => {
  return (
    <div className="relative flex min-h-full w-full flex-1 flex-col justify-center">
      <div
        className="pointer-events-none absolute inset-0 bg-linear-to-b from-black/55 via-black/45 to-black/60"
        aria-hidden
      />
      <div className="relative w-full px-6 py-16 text-center md:px-16 md:py-20">
        <div className="mx-auto flex max-w-4xl flex-col items-center gap-10 md:gap-12">
          ...
          <div className="flex flex-col gap-5 md:gap-6">
            <h1 className="text-6xl font-extralight leading-[1.05] tracking-tight text-white sm:text-7xl md:text-8xl lg:text-9xl">
              Joan Gerard
            </h1>
